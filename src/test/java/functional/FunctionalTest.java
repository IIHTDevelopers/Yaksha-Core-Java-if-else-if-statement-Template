...
public class FunctionalTest {
	...
	// Provide the path to the IfElseIfStatementAssignment class file
	String filePath = "src/main/java/com/yaksha/assignment/IfElseIfStatementAssignment.java";
	...
	@Test
	public void testIfElseIfStatementsOnly() throws Exception {
		AutoGrader autoGrader = new AutoGrader();
		boolean result = autoGrader.testIfElseIfStatementsOnly(filePath);
